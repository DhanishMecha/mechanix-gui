...
class SectionDotsWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Stack(
      ...
      children: [
        for (int i = 0; i < sections.length; i++) _buildSectionDot(context, i),
      ],
    );
  }

  Widget _buildSectionDot(BuildContext context, int index) {
                  ...
                  decoration: BoxDecoration(
                    color:
                        isActive
                            ...
                            : isHovered
                            ? context.colorScheme.surfaceDim.withValues(
                              alpha: 0.7,
                            )
                            : context.colorScheme.surfaceDim.withValues(
                              alpha: 0.4,
